 ...
 */
public class insertfaculty extends javax.swing.JFrame {

    /**
     * Creates new form insertfaculty
     */
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        ...
                        .addComponent(fln)
                        .addComponent(email)
                        .addComponent(did, javax.swing.GroupLayout.DEFAULT_SIZE, 188, Short.MAX_VALUE))
    ...
    private void insertActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_insertActionPerformed
        ...
        try{
              ...
              Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/attendance_management","admin","admin123");
                ...
                String sqlins= "insert into faculty "+"(f_id, fF_name, fL_name, f_email, d_id) "+ "values('"+fidd+"', '"+ffnn+"', '"+flnn+"', '"+emaill+"', '"+didd+"');";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(insertfaculty.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new insertfaculty().setVisible(true);
            }
        });
    }
